<?php
/*
Plugin Name: NEX-Forms Lite
Plugin URI: https://wordpress.org/plugins/x-forms-express/
Plugin Prefix: wap_ 
Module Ready: Yes
Plugin TinyMCE: popup
Description: (EXPRESS VERSION) WordPress Contact form builder
Author: Basix
Version: 3.4
...
function NEXForms_buy_now_link($links) { 
  $settings_link = '<a href="http://codecanyon.net/item/nexforms-lite-wordpress-form-builder-plugin/5214711?ref=Basix">GO PRO</a>'; 
...
<table class="table" style="margin:0px auto; background-color: #FF0000; border:1px solid #ebccd1;">
  <tr>
    <td style="color:#FFF;">You are using the express version and therefore the form entry values are starred out (*). Please <a href="http://codecanyon.net/item/nexforms-lite-wordpress-form-builder-plugin/5214711?ref=Basix" style="background-color:#ffffff;"><strong>&nbsp;UPGRADE TO NEX-FORMS LITE PRO or NEX-FORMS ULTIMATE PRO&nbsp;</strong></a> to receive form data in your emails.</td>
  </tr>
</table><br />
...
<table class="table" style="margin:0px auto; background-color: #5cb85c; border:1px solid #d6e9c6;">
  <tr>
    <td style="color:#FFF;"><a href="http://codecanyon.net/item/nexforms-lite-wordpress-form-builder-plugin/5214711?ref=Basix" style="color:#FFF; text-decoration:underline;"><strong>UPGRADE TO NEX-FORMS LITE PRO or NEX-FORMS ULTIMATE PRO!</strong></a></td>
  </tr>
</table><br />
...
function nex_forms_gopro_dashboard_widget(){
		...
		$output .= '<div class="dashboard_wrapper alert alert-success">';
			$output .= '<ul>
					...
					<a href="http://codecanyon.net/item/nexforms-lite-wordpress-form-builder-plugin/5214711?ref=Basix" target="_blank" class="btn btn-success">GO PRO for a once in a lifetime purchase of only $24</a>';
		$output .= '<div style="clear:both;"></div>';
...
function nf_gopro_admin_notice() {
	...
	if ( ! get_user_meta($user_id, 'nf_gopro_ignore_notice') ) {
        ...
        printf(__('<strong>Upgrade to <a href="http://codecanyon.net/item/nexforms-lite-wordpress-form-builder-plugin/5214711?ref=Basix">NEX-Forms Lite PRO or NEX-Forms Ultimate PRO</a> and unlock tons of extra form building features!</strong> <a href="http://codecanyon.net/item/nexforms-lite-wordpress-form-builder-plugin/5214711?ref=Basix"><strong>GO PRO</strong></a> '), '?nf_add_on_nag_ignore=0');
        echo "</p></div>";
	}
}
