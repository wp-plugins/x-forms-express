...
Please note that you are using the express version and a lot of features are blocked in this version. <a href="http://codecanyon.net/item/x-forms-wordpress-form-creator-plugin/5214711?ref=Basix">Upgrade to the pro version</a> to unlock these awesome features to make your forms look profesional! <br />
See The features the Pro version has to offer after the quick guide below or <a href="http://codecanyon.net/item/x-forms-wordpress-form-creator-plugin/5214711?ref=Basix">just click here</a>.
<h3>Here is a quick guide for using X Forms Express</h3>
<h4>Layout</h4>
<ul>
  <li>Left hand column: Contains all fields grouped into 4 sections (click on the headings to toggle through). Drag them to the canvas area and drop.</li>
  <li>Centre column: The very top contains all forms next to the &quot;New Form&quot; tab. Click on the tabs to switch forms. Next is the form title, form actions (duplicate and delete), Viewing tabs (Build, Design, Form Entries and Code), and then we have the actual form canvas where elements can be dropped, sorted (drag up or down) or removed (click on the X top right corner of the field).</li>
  <li>Right hand column: When in &quot;build&quot; view this contains General settings, Email Setup, Form Layout and Color schemes(themes). When in &quot;Design&quot; view this contains The Visual Editor, Form Layout and Color schemes(themes). Click on these to toggle hide and show.</li>
  <li>Using the Visual Editor: When in design view you will notice the visual editor on the right hand column. You can change a all of a single form element\'s style attributes by clicking on it or you can change specific elements types as a whole by using the dropdown labelled (Overall styling selections)</li>
</ul>
<h4>Field settings</h4>
<ul>
  <li><em>Editing field settings:</em> After a field has been dropped into the canvas, hover over it and you will notice a few links popup. Click on edit settings to customize the field title, error message (shown if required, or pre-formatted) and help text. If the hower state get switched around just click on current form tab agian.</li>
  <li><em>Editing Field titles, paragraphs and heading</em>: Just click on them, enter the desired name and hit enter or click somewhere away from the field.</li>
  <li><em>Radio and Check groups, Dropdowns, Autocomplete, Upload file and Date-picker fields:</em> These have settings unique to theme. you will finsd it by hover over the field.</li>
  <li>The views and setting are unigue to each form and not as n whole...</li>
</ul>
<h4>Adding a form to a page post</h4>
<ol>
  <li>Go to your post or page.</li>
  <li>Check the top strip of the editor for a &quot;XF&quot; button.</li>
  <li>Click it.</li>
  <li>Select the form you want to insert.</li>
  <li>Click insert into post.</li>
</ol>
<h4>Adding a form directly into your HTML or PHP script</h4>
<ol>
  <li>Go to X Forms</li>
  <li>Click on the form you want to insert</li>
  <li>Click on the &quot;Code&quot; tab, just below the form title</li>
  <li>follow the instructions and copy the PHP/HTML code</li>
  <li>Paste it into your HTML or PHP script</li>
</ol>
<h4>Adding a form to a Sidebar</h4>
<ol>
  <li>Go to Appearance -&gt; widgets</li>
  <li>Drag the X Forms widget into the desired sidebar</li>
  <li>Select the form the widget should include/display</li>
  <li>Click save</li>
</ol>
<h4>Known Bugs</h4>
<ul>
  <li>Unfortunately there is one bug that simple wont die and at this stage still remain: If you drag a form element onto the canvas area (center column) it sometimes does\'nt convert into the actual field. This happens mostly if the element is dropped at the very top or bottom of the form. Just drag and drop it little, almost shaking it until it converts.</li>
</ul>
<p>&nbsp;</p>
<hr />
<center>
...
<p>Best regards and happy building<br />

<strong>Basix</strong></p>
</body>
</html>
';
