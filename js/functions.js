...
function()
	...
	jQuery('select[name="change_color_scheme"]').change(
		function()
			{
			jQuery(this).parent().find('link.color_scheme').attr('href','http://webaways.com/express-themes/wp-content/plugins/x-forms-express/css/'+ jQuery(this).val() +'/jquery.ui.theme.css');	
			}
		);
